      ...
      <div style="padding: 20px 0;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
          <tr style="border-bottom: 1px solid #e2e8f0;">
            ...
            <td style="padding: 8px; font-weight: bold; color: #ef4444;">${escapeHtml(log.securityEvent)}</td>
          </tr>
          <tr style="border-bottom: 1px solid #e2e8f0;">
            <td style="padding: 8px; font-weight: bold; color: #64748b;">Attacker IP Address:</td>
            <td style="padding: 8px; font-family: monospace; font-weight: bold; color: #0f172a;">${escapeHtml(log.clientIp)}</td>
          </tr>
          <tr style="border-bottom: 1px solid #e2e8f0;">
            <td style="padding: 8px; font-weight: bold; color: #64748b;">Target Endpoint:</td>
            <td style="padding: 8px; font-family: monospace; color: #0284c7;">${escapeHtml(log.targetEndpoint) || "N/A"}</td>
          </tr>
          <tr style="border-bottom: 1px solid #e2e8f0;">
        ...
        <div style="margin-top: 15px; background-color: #f8fafc; border: 1px solid #cbd5e1; border-radius: 8px; padding: 12px;">
          ...
          <pre style="margin: 0; font-family: monospace; font-size: 12px; color: #0f172a; white-space: pre-wrap;">${escapeHtml(JSON.stringify(log, null, 2))}</pre>
        </div>

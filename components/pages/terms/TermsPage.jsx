...
export const TermsPage = () => {
    ...
    const { termsConditions } = policyData;
            ...
            <section className="hero-gradient pt-32 pb-16">
                <div className="container-custom">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl mx-auto text-center">
                        <h1 className="text-4xl md:text-5xl font-heading font-bold text-hero-foreground mb-4">{termsConditions.title}</h1>
                        <p className="text-hero-muted">Last updated: {termsConditions.lastUpdated}</p>
                    </motion.div>
                </div>
            </section>
            <Section>
